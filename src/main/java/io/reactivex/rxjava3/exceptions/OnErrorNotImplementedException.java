 ...
 * callback-based subscribe() method on a base reactive type didn't specify an onError handler.
 *
...
public final class OnErrorNotImplementedException extends RuntimeException {
  ...
  /**
   * Customizes the {@code Throwable} with a custom message and wraps it before it is signalled to
   * the {@code RxJavaPlugins.onError()} handler as {@code OnErrorNotImplementedException}.
   *
  ...
  /**
   * Wraps the {@code Throwable} before it is signalled to the {@code RxJavaPlugins.onError()}
