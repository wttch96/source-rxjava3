...
public interface MaybeOperator<@NonNull Downstream, @NonNull Upstream> {
  /**
   * Applies a function to the child {@link MaybeObserver} and returns a new parent {@code
   * MaybeObserver}.
   *
   ...
   */
  @NonNull
  MaybeObserver<? super Upstream> apply(@NonNull MaybeObserver<? super Downstream> observer)
      throws Throwable;
}
