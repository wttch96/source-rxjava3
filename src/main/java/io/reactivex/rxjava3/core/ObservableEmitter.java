...
/**
 * Abstraction over an RxJava {@link Observer} that allows associating a resource with it.
 *
 ...
 * Observer}'s methods should be. Use the {@code ObservableEmitter} the {@link #serialize()} method
 * returns instead of the original {@code ObservableEmitter} instance provided by the generator
 * routine if you want to ensure this. The other methods are thread-safe.
 *
...
public interface ObservableEmitter<@NonNull T> extends Emitter<T> {
  ...
  /**
   * Sets a {@link Disposable} on this emitter; any previous {@code Disposable} or {@link
