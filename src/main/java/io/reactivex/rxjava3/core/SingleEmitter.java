...
/**
 * Abstraction over an RxJava {@link SingleObserver} that allows associating a resource with it.
 *
 ...
 *
 * <p>Calling {@link #onSuccess(Object)} multiple times has no effect. Calling {@link
 * #onError(Throwable)} multiple times or after {@code onSuccess} will route the exception into the
 ...
 * #onSuccess(Object)}, {@link #onError(Throwable)}, or when {@link #tryOnError(Throwable)}
 * succeeds.
 *
...
public interface SingleEmitter<@NonNull T> {
   ...
   * #onSuccess(Object)}, {@link #onError(Throwable)}, or a successful {@link
