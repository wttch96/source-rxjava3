...
/**
 * Convenience interface and callback used by the {@link Maybe#to} operator to turn a {@link Maybe}
...
public interface MaybeConverter<@NonNull T, @NonNull R> {
  /**
   * Applies a function to the upstream {@link Maybe} and returns a converted value of type {@code
   * R}.
   *
