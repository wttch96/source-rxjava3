...
/**
 * A functional interface that has a {@code subscribe()} method that receives an instance of an
 * {@link ObservableEmitter} instance that allows pushing events in a cancellation-safe manner.
 *
