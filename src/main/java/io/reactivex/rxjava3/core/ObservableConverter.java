...
/**
 * Convenience interface and callback used by the {@link Observable#to} operator to turn an {@link
...
public interface ObservableConverter<@NonNull T, @NonNull R> {
  /**
   * Applies a function to the upstream {@link Observable} and returns a converted value of type
   * {@code R}.
   *
