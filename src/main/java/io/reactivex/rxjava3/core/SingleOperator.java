...
public interface SingleOperator<@NonNull Downstream, @NonNull Upstream> {
  /**
   * Applies a function to the child {@link SingleObserver} and returns a new parent {@code
   * SingleObserver}.
   *
   ...
   */
  @NonNull
  SingleObserver<? super Upstream> apply(@NonNull SingleObserver<? super Downstream> observer)
      throws Throwable;
}
