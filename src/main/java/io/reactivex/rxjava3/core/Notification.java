...
public final class Notification<T> {
  ...
  /**
   * Returns true if this notification is an {@code onError} signal and {@link #getError()} returns
   * the contained {@link Throwable}.
   *
  ...
  /**
   * Returns true if this notification is an {@code onNext} signal and {@link #getValue()} returns
   * the contained value.
   *
  ...
  /**
   * Returns the contained value if this notification is an {@code onNext} signal, null otherwise.
   *
  ...
  /**
   * Returns the empty and stateless shared instance of a notification representing an {@code
   * onComplete} signal.
   *
