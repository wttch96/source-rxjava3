...
/**
 * Represents a basic {@link Single} source base interface, consumable via an {@link
 * SingleObserver}.
 *
 * <p>This class also serves the base type for custom operators wrapped into Single via {@link
