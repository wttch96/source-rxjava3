...
/**
 * Abstraction over an RxJava {@link MaybeObserver} that allows associating a resource with it.
 *
 ...
 *
 * <p>Calling {@link #onSuccess(Object)} or {@link #onComplete()} multiple times has no effect.
 * Calling {@link #onError(Throwable)} multiple times or after the other two will route the
 * exception into the global error handler via {@link
 ...
 * #onSuccess(Object)}, {@link #onError(Throwable)}, {@link #onComplete()} or when {@link
...
public interface MaybeEmitter<@NonNull T> {
   ...
   * #onSuccess(Object)}, {@link #onError(Throwable)}, {@link #onComplete} or a successful {@link
