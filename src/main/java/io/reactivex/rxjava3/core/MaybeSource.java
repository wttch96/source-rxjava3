...
/**
 * Represents a basic {@link Maybe} source base interface, consumable via an {@link MaybeObserver}.
 *
 * <p>This class also serves the base type for custom operators wrapped into Maybe via {@link
