...
/**
 * Serializes access to the {@link Subscriber#onNext(Object)}, {@link Subscriber#onError(Throwable)}
 * and {@link Subscriber#onComplete()} methods of another {@link Subscriber}.
 *
 * <p>Note that {@link #onSubscribe(Subscription)} is not serialized in respect of the other methods
 * so make sure the {@code onSubscribe} is called with a non-{@code null} {@link Subscription}
...
public final class SerializedSubscriber<T> implements FlowableSubscriber<T>, Subscription {
   ...
   * optionally delaying the errors till all regular values have been emitted from the internal
   * buffer.
   *
