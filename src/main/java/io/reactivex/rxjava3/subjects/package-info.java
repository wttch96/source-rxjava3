...
/**
 * Classes representing so-called hot sources, aka <strong>subjects</strong>, that implement a base
 * reactive class and the respective consumer type at once to allow forms of multicasting events to
 * multiple consumers as well as consuming another base reactive type of their kind.
 *
 * <p>Available subject classes with their respective base classes and consumer interfaces: <br>
 *
 ...
 * </table>
 *
 * <p>The backpressure-aware variants of the {@code Subject} class are called {@link
 * org.reactivestreams.Processor}s and reside in the {@code io.reactivex.processors} package.
 *
