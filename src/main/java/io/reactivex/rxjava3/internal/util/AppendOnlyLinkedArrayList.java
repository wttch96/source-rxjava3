...
public class AppendOnlyLinkedArrayList<T> {
  ...
  /**
   * Loops over all elements of the array until a null element is encountered or the given predicate
   * returns true.
   *
  ...
  /**
   * Interprets the contents as NotificationLite objects and calls the appropriate Subscriber
   * method.
   *
