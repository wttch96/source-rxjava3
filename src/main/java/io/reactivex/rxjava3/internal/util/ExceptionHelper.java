...
public final class ExceptionHelper {
  ...
  /**
   * If the provided Throwable is an Error this method throws it, otherwise returns a
   * RuntimeException wrapping the error if that error is a checked exception.
   *
  ...
  /**
   * A singleton instance of a Throwable indicating a terminal state for exceptions, don't leak
   * this.
   */
  ...
  /**
   * Similar to Objects.requireNonNull but composes the error message via {@link
   * #nullWarning(String)}.
   *
