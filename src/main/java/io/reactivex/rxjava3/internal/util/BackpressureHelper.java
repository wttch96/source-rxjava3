...
public final class BackpressureHelper {
  ...
  /**
   * Atomically adds the positive value n to the requested value in the {@link AtomicLong} and caps
   * the result at {@link Long#MAX_VALUE} and returns the previous value.
   *
  ...
  /**
   * Atomically adds the positive value n to the requested value in the {@link AtomicLong} and caps
   * the result at {@link Long#MAX_VALUE} and returns the previous value and considers {@link
  ...
  /**
   * Atomically subtract the given number (positive, not validated) from the target field if it
   * doesn't contain {@link Long#MIN_VALUE} (indicating some cancelled state) or {@link
