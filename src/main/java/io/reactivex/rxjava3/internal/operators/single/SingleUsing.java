...
public final class SingleUsing<T, U> extends Single<T> {
    ...
    try {
      source =
          Objects.requireNonNull(
              singleFunction.apply(resource), "The singleFunction returned a null SingleSource");
    } catch (Throwable ex) {
      Exceptions.throwIfFatal(ex);
  ...
  static final class UsingSingleObserver<T, U> extends AtomicReference<Object>
