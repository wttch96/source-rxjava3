...
public final class FlowableSkipLastTimed<T> extends AbstractFlowableWithUpstream<T, T> {
  ...
  protected void subscribeActual(Subscriber<? super T> s) {
    source.subscribe(
        new SkipLastTimedSubscriber<>(s, time, unit, scheduler, bufferSize, delayError));
  }

  static final class SkipLastTimedSubscriber<T> extends AtomicInteger
