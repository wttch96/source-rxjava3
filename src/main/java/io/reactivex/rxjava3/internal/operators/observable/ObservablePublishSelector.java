...
public final class ObservablePublishSelector<T, R> extends AbstractObservableWithUpstream<T, R> {
  ...
  public ObservablePublishSelector(
    ...
    try {
      target =
          Objects.requireNonNull(
              selector.apply(subject), "The selector returned a null ObservableSource");
    } catch (Throwable ex) {
  ...
  static final class TargetObserver<R> extends AtomicReference<Disposable>
