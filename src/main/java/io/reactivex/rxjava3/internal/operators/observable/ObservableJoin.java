...
import io.reactivex.rxjava3.internal.operators.observable.ObservableGroupJoin.JoinSupport;
import io.reactivex.rxjava3.internal.operators.observable.ObservableGroupJoin.LeftRightEndObserver;
import io.reactivex.rxjava3.internal.operators.observable.ObservableGroupJoin.LeftRightObserver;
...
public final class ObservableJoin<TLeft, TRight, TLeftEnd, TRightEnd, R>
  ...
  protected void subscribeActual(Observer<? super R> observer) {
    ...
    JoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> parent =
        new JoinDisposable<>(observer, leftEnd, rightEnd, resultSelector);
  ...
  static final class JoinDisposable<TLeft, TRight, TLeftEnd, TRightEnd, R> extends AtomicInteger
        ...
        for (; ; ) {
          ...
          if (mode == LEFT_VALUE) {
            ...
            try {
              p =
                  Objects.requireNonNull(
                      leftEnd.apply(left), "The leftEnd returned a null ObservableSource");
            } catch (Throwable exc) {
              fail(exc, a, q);
              return;
            }
            ...
            try {
              p =
                  Objects.requireNonNull(
                      rightEnd.apply(right), "The rightEnd returned a null ObservableSource");
            } catch (Throwable exc) {
              fail(exc, a, q);
              return;
            }
