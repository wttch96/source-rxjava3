...
/**
 * Maps the success value of a Maybe onto an ObservableSource and relays its signals to the
 * downstream observer.
 *
...
public final class MaybeFlatMapObservable<T, R> extends Observable<R> {
  ...
  public MaybeFlatMapObservable(
      MaybeSource<T> source, Function<? super T, ? extends ObservableSource<? extends R>> mapper) {
    this.source = source;
    this.mapper = mapper;
  }
  ...
  static final class FlatMapObserver<T, R> extends AtomicReference<Disposable>
