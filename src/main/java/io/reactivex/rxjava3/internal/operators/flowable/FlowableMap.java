...
public final class FlowableMap<T, U> extends AbstractFlowableWithUpstream<T, U> {
  ...
  protected void subscribeActual(Subscriber<? super U> s) {
    if (s instanceof ConditionalSubscriber) {
      source.subscribe(
          new MapConditionalSubscriber<T, U>((ConditionalSubscriber<? super U>) s, mapper));
    } else {
  ...
  static final class MapSubscriber<T, U> extends BasicFuseableSubscriber<T, U> {
    ...
    public U poll() throws Throwable {
      T t = qs.poll();
      return t != null
          ? Objects.requireNonNull(mapper.apply(t), "The mapper function returned a null value.")
          : null;
    }
  }
  ...
  static final class MapConditionalSubscriber<T, U>
    ...
    MapConditionalSubscriber(
        ConditionalSubscriber<? super U> actual, Function<? super T, ? extends U> function) {
      super(actual);
