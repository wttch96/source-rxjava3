 ...
 *
 * <p>By having a concrete Publisher as lift, operator fusing can now identify both the source and
 * the operation inside it via casting, unlike the lambda version of this.
 *
