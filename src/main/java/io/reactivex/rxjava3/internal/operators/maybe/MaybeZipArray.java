...
public final class MaybeZipArray<T, R> extends Maybe<R> {
  ...
  public MaybeZipArray(
      MaybeSource<? extends T>[] sources, Function<? super Object[], ? extends R> zipper) {
  ...
  static final class ZipMaybeObserver<T> extends AtomicReference<Disposable>
  ...
  final class SingletonArrayFunc implements Function<T, R> {
    ...
    public R apply(T t) throws Throwable {
      return Objects.requireNonNull(
          zipper.apply(new Object[] {t}), "The zipper returned a null value");
    }
  }
}
