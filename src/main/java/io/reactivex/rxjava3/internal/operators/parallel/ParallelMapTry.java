...
/**
 * Maps each 'rail' of the source ParallelFlowable with a mapper function and handle any failure
 * based on a handler function.
 *
  ...
  public void subscribe(Subscriber<? super R>[] subscribers) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (a instanceof ConditionalSubscriber) {
        parents[i] =
            new ParallelMapTryConditionalSubscriber<T, R>(
                (ConditionalSubscriber<? super R>) a, mapper, errorHandler);
      } else {
