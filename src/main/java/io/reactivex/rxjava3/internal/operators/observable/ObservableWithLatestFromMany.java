...
/**
 * Combines a main sequence of values with the latest from multiple other sequences via a selector
 * function.
 *
...
public final class ObservableWithLatestFromMany<T, R> extends AbstractObservableWithUpstream<T, R> {
  ...
  @Nullable final ObservableSource<?>[] otherArray;

  @Nullable final Iterable<? extends ObservableSource<?>> otherIterable;

  @NonNull final Function<? super Object[], R> combiner;

  public ObservableWithLatestFromMany(
      @NonNull ObservableSource<T> source,
      @NonNull ObservableSource<?>[] otherArray,
  ...
  public ObservableWithLatestFromMany(
      @NonNull ObservableSource<T> source,
      @NonNull Iterable<? extends ObservableSource<?>> otherIterable,
      @NonNull Function<? super Object[], R> combiner) {
    super(source);
  ...
  static final class WithLatestFromObserver<T, R> extends AtomicInteger
    ...
    WithLatestFromObserver(
        Observer<? super R> actual, Function<? super Object[], R> combiner, int n) {
  ...
  static final class WithLatestInnerObserver extends AtomicReference<Disposable>
