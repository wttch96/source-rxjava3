...
public final class ObservableGroupBy<T, K, V>
  ...
  public static final class GroupByObserver<T, K, V> extends AtomicInteger
  ...
  static final class GroupedUnicast<K, T> extends GroupedObservable<K, T> {
    ...
    public static <T, K> GroupedUnicast<K, T> createWith(
        K key, int bufferSize, GroupByObserver<?, K, T> parent, boolean delayError) {
