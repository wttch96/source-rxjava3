...
public final class FlowableBuffer<T, C extends Collection<? super T>>
  ...
  static final class PublisherBufferExactSubscriber<T, C extends Collection<? super T>>
    ...
    PublisherBufferExactSubscriber(
        Subscriber<? super C> actual, int size, Supplier<C> bufferSupplier) {
        ...
        try {
          b =
              Objects.requireNonNull(
                  bufferSupplier.get(), "The bufferSupplier returned a null buffer");
        } catch (Throwable e) {
  ...
  static final class PublisherBufferSkipSubscriber<T, C extends Collection<? super T>>
    ...
    PublisherBufferSkipSubscriber(
        Subscriber<? super C> actual, int size, int skip, Supplier<C> bufferSupplier) {
      this.downstream = actual;
      this.size = size;
      this.skip = skip;
      this.bufferSupplier = bufferSupplier;
  ...
  static final class PublisherBufferOverlappingSubscriber<T, C extends Collection<? super T>>
      extends AtomicLong implements FlowableSubscriber<T>, Subscription, BooleanSupplier {
