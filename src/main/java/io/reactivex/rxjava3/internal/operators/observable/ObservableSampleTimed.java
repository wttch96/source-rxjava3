...
public final class ObservableSampleTimed<T> extends AbstractObservableWithUpstream<T, T> {
  ...
  abstract static class SampleTimedObserver<T> extends AtomicReference<T>
    ...
    SampleTimedObserver(
        Observer<? super T> actual, long period, TimeUnit unit, Scheduler scheduler) {
