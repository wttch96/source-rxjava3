...
/**
 * Wraps a {@link ConnectableFlowable} and calls its {@code connect()} method once the specified
 * number of {@link Subscriber}s have subscribed.
 *
...
public final class FlowableAutoConnect<T> extends Flowable<T> {
  ...
  public FlowableAutoConnect(
      ConnectableFlowable<? extends T> source,
