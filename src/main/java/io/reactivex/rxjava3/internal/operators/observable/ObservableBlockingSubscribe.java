...
public final class ObservableBlockingSubscribe {
   ...
   * <p>
   *
   * @param o the source ObservableSource The call to dispose() is composed through.
  ...
  public static <T> void subscribe(ObservableSource<? extends T> o) {
    ...
    LambdaObserver<T> ls =
        new LambdaObserver<>(
            Functions.emptyConsumer(), callback, callback, Functions.emptyConsumer());
