...
public final class ObservableWindowBoundary<T, B>
  ...
  public ObservableWindowBoundary(
      ObservableSource<T> source, ObservableSource<B> other, int capacityHint) {
    super(source);
    this.other = other;
  ...
  public void subscribeActual(Observer<? super Observable<T>> observer) {
    WindowBoundaryMainObserver<T, B> parent =
        new WindowBoundaryMainObserver<>(observer, capacityHint);
  ...
  static final class WindowBoundaryMainObserver<T, B> extends AtomicInteger
        ...
        for (; ; ) {
          ...
          if (!stopWindows.get()) {
            ...
            ObservableWindowSubscribeIntercept<T> intercept =
                new ObservableWindowSubscribeIntercept<>(w);
