...
/**
 * Subscribes to the source Flowable on the specified Scheduler and makes sure downstream requests
 * are scheduled there as well.
 *
...
public final class FlowableSubscribeOn<T> extends AbstractFlowableWithUpstream<T, T> {
  ...
  public FlowableSubscribeOn(
      Flowable<T> source, Scheduler scheduler, boolean nonScheduledRequests) {
    super(source);
  ...
  public void subscribeActual(final Subscriber<? super T> s) {
    ...
    final SubscribeOnSubscriber<T> sos =
        new SubscribeOnSubscriber<>(s, w, source, nonScheduledRequests);
    s.onSubscribe(sos);
