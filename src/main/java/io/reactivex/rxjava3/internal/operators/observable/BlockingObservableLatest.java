...
/**
 * Wait for and iterate over the latest values of the source observable. If the source works faster
 * than the iterator, values may be skipped, but not the {@code onError} or {@code onComplete}
 * events.
 *
...
public final class BlockingObservableLatest<T> implements Iterable<T> {
  ...
  static final class BlockingObservableLatestIterator<T> extends DisposableObserver<Notification<T>>
