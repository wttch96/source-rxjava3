...
public final class ObservableSequenceEqualSingle<T> extends Single<Boolean>
  ...
  public ObservableSequenceEqualSingle(
      ObservableSource<? extends T> first,
  ...
  public Observable<Boolean> fuseToObservable() {
    return RxJavaPlugins.onAssembly(
        new ObservableSequenceEqual<>(first, second, comparer, bufferSize));
  }
