...
public final class ObservableWithLatestFrom<T, U, R> extends AbstractObservableWithUpstream<T, R> {
  ...
  public ObservableWithLatestFrom(
  ...
  static final class WithLatestFromObserver<T, U, R> extends AtomicReference<U>
    ...
    WithLatestFromObserver(
        Observer<? super R> actual, BiFunction<? super T, ? super U, ? extends R> combiner) {
