 ...
 * while disposing the older ones and emits the latest success value if available, optionally
 * delaying errors from the main source or the inner sources.
 *
...
public final class ObservableSwitchMapSingle<T, R> extends Observable<R> {
  ...
  public ObservableSwitchMapSingle(
      Observable<T> source,
  ...
  static final class SwitchMapSingleMainObserver<T, R> extends AtomicInteger
    ...
    static final class SwitchMapSingleObserver<R> extends AtomicReference<Disposable>
