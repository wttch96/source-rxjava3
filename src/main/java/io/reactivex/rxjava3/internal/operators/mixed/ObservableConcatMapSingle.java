...
/**
 * Maps each upstream item into a {@link SingleSource}, subscribes to them one after the other
...
public final class ObservableConcatMapSingle<T, R> extends Observable<R> {
  ...
  public ObservableConcatMapSingle(
  ...
  static final class ConcatMapSingleMainObserver<T, R> extends AtomicInteger
            ...
            try {
              ss =
                  Objects.requireNonNull(
                      mapper.apply(v), "The mapper returned a null SingleSource");
            } catch (Throwable ex) {
    ...
    static final class ConcatMapSingleObserver<R> extends AtomicReference<Disposable>
