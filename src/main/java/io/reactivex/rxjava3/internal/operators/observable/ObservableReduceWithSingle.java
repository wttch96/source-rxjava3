...
/**
 * Reduce a sequence of values, starting from a generated seed value and by using an accumulator
 * function and return the last accumulated value.
 *
...
public final class ObservableReduceWithSingle<T, R> extends Single<R> {
  ...
  public ObservableReduceWithSingle(
      ObservableSource<T> source, Supplier<R> seedSupplier, BiFunction<R, ? super T, R> reducer) {
    this.source = source;
