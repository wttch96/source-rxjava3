...
/**
 * Calls a Consumer for each upstream value passing by and handles any failure with a handler
 * function.
 *
  ...
  public void subscribe(Subscriber<? super T>[] subscribers) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (a instanceof ConditionalSubscriber) {
        parents[i] =
            new ParallelDoOnNextConditionalSubscriber<>(
                (ConditionalSubscriber<? super T>) a, onNext, errorHandler);
      } else {
