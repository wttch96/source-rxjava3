 ...
 *
 * <p>By having a concrete ObservableSource as lift, operator fusing can now identify both the
 * source and the operation inside it via casting, unlike the lambda version of this.
 *
    ...
    try {
      liftedObserver =
          Objects.requireNonNull(
              operator.apply(observer), "Operator " + operator + " returned a null Observer");
