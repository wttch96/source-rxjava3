...
public final class FlowableUsing<T, D> extends Flowable<T> {
    ...
    try {
      source =
          Objects.requireNonNull(
              sourceSupplier.apply(resource), "The sourceSupplier returned a null Publisher");
    } catch (Throwable e) {
      Exceptions.throwIfFatal(e);
      try {
  ...
  static final class UsingSubscriber<T, D> extends AtomicBoolean
    ...
    UsingSubscriber(
        Subscriber<? super T> actual, D resource, Consumer<? super D> disposer, boolean eager) {
