...
/**
 * Reduces a sequence via a function into a single value or signals NoSuchElementException for an
 * empty source.
 *
...
public final class FlowableReduce<T> extends AbstractFlowableWithUpstream<T, T> {
  ...
  static final class ReduceSubscriber<T> extends DeferredScalarSubscription<T>
