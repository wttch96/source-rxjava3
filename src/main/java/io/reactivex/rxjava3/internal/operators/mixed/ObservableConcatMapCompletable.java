...
public final class ObservableConcatMapCompletable<T> extends Completable {
  ...
  public ObservableConcatMapCompletable(
      Observable<T> source,
  ...
  static final class ConcatMapCompletableObserver<T> extends AtomicInteger
            ...
            if (v != null) {
              cs =
                  Objects.requireNonNull(
                      mapper.apply(v), "The mapper returned a null CompletableSource");
              empty = false;
            }
          } catch (Throwable ex) {
