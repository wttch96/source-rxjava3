...
/**
 * Merges an Observable and a Maybe by emitting the items of the Observable and the success value of
 * the Maybe and waiting until both the Observable and Maybe terminate normally.
 *
