...
/**
 * Dispatches the values from upstream in a round robin fashion to subscribers which are ready to
 * consume elements. A value from upstream is sent to only one of the subscribers.
 *
...
public final class ParallelFromPublisher<T> extends ParallelFlowable<T> {
  ...
  static final class ParallelDispatcher<T> extends AtomicInteger implements FlowableSubscriber<T> {
    ...
    /**
     * Counts how many subscribers were setup to delay triggering the drain of upstream until all of
     * them have been setup.
     */
