...
public final class MaybeFlatMapNotification<T, R> extends AbstractMaybeWithUpstream<T, R> {
  ...
  static final class FlatMapMaybeObserver<T, R> extends AtomicReference<Disposable>
      ...
      try {
        source =
            Objects.requireNonNull(
                onSuccessMapper.apply(value), "The onSuccessMapper returned a null MaybeSource");
      } catch (Throwable ex) {
    ...
    public void onError(Throwable e) {
      ...
      try {
        source =
            Objects.requireNonNull(
                onErrorMapper.apply(e), "The onErrorMapper returned a null MaybeSource");
      } catch (Throwable ex) {
        Exceptions.throwIfFatal(ex);
    ...
    public void onComplete() {
      ...
      try {
        source =
            Objects.requireNonNull(
                onCompleteSupplier.get(), "The onCompleteSupplier returned a null MaybeSource");
      } catch (Throwable ex) {
        Exceptions.throwIfFatal(ex);
        downstream.onError(ex);
        return;
