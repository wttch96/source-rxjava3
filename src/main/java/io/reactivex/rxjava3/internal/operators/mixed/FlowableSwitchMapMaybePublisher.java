...
/**
 * Switch between subsequent {@link MaybeSource}s emitted by a {@link Publisher}. Reuses {@link
 * FlowableSwitchMapMaybe} internals.
 *
...
public final class FlowableSwitchMapMaybePublisher<T, R> extends Flowable<R> {
  ...
  public FlowableSwitchMapMaybePublisher(
      Publisher<T> source,
