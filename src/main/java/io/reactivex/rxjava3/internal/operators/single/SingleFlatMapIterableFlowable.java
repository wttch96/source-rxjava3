...
public final class SingleFlatMapIterableFlowable<T, R> extends Flowable<R> {
  ...
  public SingleFlatMapIterableFlowable(
      SingleSource<T> source, Function<? super T, ? extends Iterable<? extends R>> mapper) {
    this.source = source;
    this.mapper = mapper;
  }
  ...
  static final class FlatMapIterableObserver<T, R> extends BasicIntQueueSubscription<R>
    ...
    FlatMapIterableObserver(
        Subscriber<? super R> actual, Function<? super T, ? extends Iterable<? extends R>> mapper) {
