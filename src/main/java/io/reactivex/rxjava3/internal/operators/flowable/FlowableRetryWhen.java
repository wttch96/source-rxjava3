...
import io.reactivex.rxjava3.internal.operators.flowable.FlowableRepeatWhen.WhenReceiver;
import io.reactivex.rxjava3.internal.operators.flowable.FlowableRepeatWhen.WhenSourceSubscriber;
...
public final class FlowableRetryWhen<T> extends AbstractFlowableWithUpstream<T, T> {
  ...
  public FlowableRetryWhen(
      Flowable<T> source, Function<? super Flowable<Throwable>, ? extends Publisher<?>> handler) {
    super(source);
  ...
  static final class RetryWhenSubscriber<T> extends WhenSourceSubscriber<T, Throwable> {
    ...
    RetryWhenSubscriber(
        ...
        FlowableProcessor<Throwable> processor,
