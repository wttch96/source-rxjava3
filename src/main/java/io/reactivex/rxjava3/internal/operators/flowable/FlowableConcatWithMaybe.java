...
/**
 * Subscribe to a main Flowable first, then when it completes normally, subscribe to a Maybe, signal
 * its success value followed by a completion or signal its error or completion signal as is.
 *
