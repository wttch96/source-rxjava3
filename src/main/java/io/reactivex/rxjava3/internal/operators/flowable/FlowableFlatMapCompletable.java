...
public final class FlowableFlatMapCompletable<T> extends AbstractFlowableWithUpstream<T, T> {
  ...
  public FlowableFlatMapCompletable(
      Flowable<T> source,
  ...
  protected void subscribeActual(Subscriber<? super T> subscriber) {
    source.subscribe(
        new FlatMapCompletableMainSubscriber<>(subscriber, mapper, delayErrors, maxConcurrency));
  }
  ...
  static final class FlatMapCompletableMainSubscriber<T> extends BasicIntQueueSubscription<T>
    ...
    final class InnerConsumer extends AtomicReference<Disposable>
