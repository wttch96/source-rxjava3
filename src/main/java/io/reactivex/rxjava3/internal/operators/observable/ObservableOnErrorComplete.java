...
public final class ObservableOnErrorComplete<T> extends AbstractObservableWithUpstream<T, T> {
  ...
  public ObservableOnErrorComplete(
      ObservableSource<T> source, Predicate<? super Throwable> predicate) {
    super(source);
  ...
  public static final class OnErrorCompleteObserver<T> implements Observer<T>, Disposable {
    ...
    public OnErrorCompleteObserver(
        Observer<? super T> actual, Predicate<? super Throwable> predicate) {
