...
public final class ObservableScalarXMap {
   ...
   * @param mapper the function that gets the scalar value and should return an ObservableSource
   *     that gets streamed
   * @return the new Observable instance
   */
  public static <T, U> Observable<U> scalarXMap(
      T value, Function<? super T, ? extends ObservableSource<? extends U>> mapper) {
  ...
  static final class ScalarXMapObservable<T, R> extends Observable<R> {
    ...
    ScalarXMapObservable(
        T value, Function<? super T, ? extends ObservableSource<? extends R>> mapper) {
      this.value = value;
      this.mapper = mapper;
    }
