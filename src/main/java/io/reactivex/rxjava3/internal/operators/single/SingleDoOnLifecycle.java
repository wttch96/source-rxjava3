...
/**
 * Invokes callbacks upon {@code onSubscribe} from upstream and {@code dispose} from downstream.
 *
...
public final class SingleDoOnLifecycle<T> extends Single<T> {
  ...
  public SingleDoOnLifecycle(
      Single<T> upstream, Consumer<? super Disposable> onSubscribe, Action onDispose) {
  ...
  static final class SingleLifecycleObserver<T> implements SingleObserver<T>, Disposable {
    ...
    public void onSubscribe(@NonNull Disposable d) {
      // this way, multiple calls to onSubscribe can show up in tests that use doOnSubscribe to
      // validate behavior
      try {
