...
public final class MaybeOnErrorNext<T> extends AbstractMaybeWithUpstream<T, T> {
  ...
  static final class OnErrorNextMaybeObserver<T> extends AtomicReference<Disposable>
      ...
      try {
        m =
            Objects.requireNonNull(
                resumeFunction.apply(e), "The resumeFunction returned a null MaybeSource");
      } catch (Throwable ex) {
