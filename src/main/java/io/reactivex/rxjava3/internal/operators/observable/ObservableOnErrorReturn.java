...
public final class ObservableOnErrorReturn<T> extends AbstractObservableWithUpstream<T, T> {
  ...
  public ObservableOnErrorReturn(
      ObservableSource<T> source, Function<? super Throwable, ? extends T> valueSupplier) {
    super(source);
  ...
  static final class OnErrorReturnObserver<T> implements Observer<T>, Disposable {
    ...
    OnErrorReturnObserver(
        Observer<? super T> actual, Function<? super Throwable, ? extends T> valueSupplier) {
