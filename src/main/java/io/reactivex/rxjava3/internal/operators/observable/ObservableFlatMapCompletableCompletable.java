...
public final class ObservableFlatMapCompletableCompletable<T> extends Completable
  ...
  public ObservableFlatMapCompletableCompletable(
  ...
  public Observable<T> fuseToObservable() {
    return RxJavaPlugins.onAssembly(
        new ObservableFlatMapCompletable<>(source, mapper, delayErrors));
  }

  static final class FlatMapCompletableMainObserver<T> extends AtomicInteger
