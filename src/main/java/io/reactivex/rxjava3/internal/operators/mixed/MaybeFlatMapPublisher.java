...
/**
 * Maps the success value of a Maybe onto a Publisher and relays its signals to the downstream
 * subscriber.
 *
...
public final class MaybeFlatMapPublisher<T, R> extends Flowable<R> {
  ...
  public MaybeFlatMapPublisher(
      MaybeSource<T> source, Function<? super T, ? extends Publisher<? extends R>> mapper) {
    this.source = source;
    this.mapper = mapper;
  }
  ...
  static final class FlatMapPublisherSubscriber<T, R> extends AtomicReference<Subscription>
