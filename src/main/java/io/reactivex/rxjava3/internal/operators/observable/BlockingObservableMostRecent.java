 ...
 * src="https://github.com/ReactiveX/RxJava/wiki/images/rx-operators/B.mostRecent.v3.png" alt="">
 *
...
public final class BlockingObservableMostRecent<T> implements Iterable<T> {
  ...
  static final class MostRecentObserver<T> extends DefaultObserver<T> {
    ...
    /**
     * The {@link MostRecentIterator} return is not thread safe. In other words don't call {@link
     * MostRecentIterator#hasNext()} in one thread expect {@link MostRecentIterator#next()} called
     * from a different thread to work.
     *
     * @return the Iterator
     */
    ...
    final class MostRecentIterator implements java.util.Iterator<T> {
      /**
       * buffer to make sure that the state of the iterator doesn't change between calling hasNext()
       * and next().
       */
      private Object buf;
