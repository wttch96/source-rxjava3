...
public final class FlowableCombineLatest<T, R> extends Flowable<R> {
  ...
  @Nullable final Publisher<? extends T>[] array;

  @Nullable final Iterable<? extends Publisher<? extends T>> iterable;
  ...
  public FlowableCombineLatest(
      @NonNull Publisher<? extends T>[] array,
  ...
  public FlowableCombineLatest(
      @NonNull Iterable<? extends Publisher<? extends T>> iterable,
      @NonNull Function<? super Object[], ? extends R> combiner,
      int bufferSize,
      boolean delayErrors) {
    this.array = null;
  ...
  static final class CombineLatestInnerSubscriber<T> extends AtomicReference<Subscription>
