...
public final class SingleFlatMapNotification<T, R> extends Single<R> {
  ...
  public SingleFlatMapNotification(
  ...
  static final class FlatMapSingleObserver<T, R> extends AtomicReference<Disposable>
      ...
      try {
        source =
            Objects.requireNonNull(
                onSuccessMapper.apply(value), "The onSuccessMapper returned a null SingleSource");
      } catch (Throwable ex) {
    ...
    public void onError(Throwable e) {
      ...
      try {
        source =
            Objects.requireNonNull(
                onErrorMapper.apply(e), "The onErrorMapper returned a null SingleSource");
      } catch (Throwable ex) {
        Exceptions.throwIfFatal(ex);
