...
/**
 * Switches to the fallback Maybe if the other Publisher signals a success or completes, or signals
 * TimeoutException if fallback is null.
 *
...
public final class MaybeTimeoutPublisher<T, U> extends AbstractMaybeWithUpstream<T, T> {
  ...
  public MaybeTimeoutPublisher(
      MaybeSource<T> source, Publisher<U> other, MaybeSource<? extends T> fallback) {
    super(source);
    this.other = other;
  ...
  static final class TimeoutMainMaybeObserver<T, U> extends AtomicReference<Disposable>
  ...
  static final class TimeoutOtherMaybeObserver<T, U> extends AtomicReference<Subscription>
  ...
  static final class TimeoutFallbackMaybeObserver<T> extends AtomicReference<Disposable>
