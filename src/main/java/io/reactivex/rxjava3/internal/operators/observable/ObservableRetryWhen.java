...
public final class ObservableRetryWhen<T> extends AbstractObservableWithUpstream<T, T> {
    ...
    try {
      other =
          Objects.requireNonNull(
              handler.apply(signaller), "The handler returned a null ObservableSource");
    } catch (Throwable ex) {
  ...
  static final class RepeatWhenObserver<T> extends AtomicInteger
    ...
    RepeatWhenObserver(
        Observer<? super T> actual, Subject<Throwable> signaller, ObservableSource<T> source) {
    ...
    final class InnerRepeatObserver extends AtomicReference<Disposable>
