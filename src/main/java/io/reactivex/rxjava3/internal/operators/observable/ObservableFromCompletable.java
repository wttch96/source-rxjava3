 ...
 * @since 3.0.0
 */
public final class ObservableFromCompletable<T> extends Observable<T>
  ...
  public static final class FromCompletableObserver<T> extends AbstractEmptyQueueFuseable<T>
