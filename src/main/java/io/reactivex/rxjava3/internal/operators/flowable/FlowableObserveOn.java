...
public final class FlowableObserveOn<T> extends AbstractFlowableWithUpstream<T, T> {
  ...
  public FlowableObserveOn(
      Flowable<T> source, Scheduler scheduler, boolean delayError, int prefetch) {
    super(source);
  ...
  public void subscribeActual(Subscriber<? super T> s) {
    ...
    if (s instanceof ConditionalSubscriber) {
      source.subscribe(
          new ObserveOnConditionalSubscriber<>(
  ...
  static final class ObserveOnSubscriber<T> extends BaseObserveOnSubscriber<T>
    ...
    ObserveOnSubscriber(
        Subscriber<? super T> actual, Worker worker, boolean delayError, int prefetch) {
  ...
  static final class ObserveOnConditionalSubscriber<T> extends BaseObserveOnSubscriber<T> {
    ...
    ObserveOnConditionalSubscriber(
        ConditionalSubscriber<? super T> actual, Worker worker, boolean delayError, int prefetch) {
      super(worker, delayError, prefetch);
      this.downstream = actual;
    }
