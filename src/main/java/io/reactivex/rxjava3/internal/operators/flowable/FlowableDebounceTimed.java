...
public final class FlowableDebounceTimed<T> extends AbstractFlowableWithUpstream<T, T> {
  ...
  public FlowableDebounceTimed(
      Flowable<T> source, long timeout, TimeUnit unit, Scheduler scheduler) {
    super(source);
  ...
  static final class DebounceTimedSubscriber<T> extends AtomicLong
    ...
    DebounceTimedSubscriber(
        Subscriber<? super T> actual, long timeout, TimeUnit unit, Worker worker) {
