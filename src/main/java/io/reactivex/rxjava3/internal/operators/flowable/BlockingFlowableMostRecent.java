...
public final class BlockingFlowableMostRecent<T> implements Iterable<T> {
  ...
  static final class MostRecentSubscriber<T> extends DefaultSubscriber<T> {
    ...
    /**
     * The {@link Iterator} return is not thread safe. In other words don't call {@link
     * Iterator#hasNext()} in one thread expect {@link Iterator#next()} called from a different
     * thread to work.
     *
     * @return the Iterator
     */
