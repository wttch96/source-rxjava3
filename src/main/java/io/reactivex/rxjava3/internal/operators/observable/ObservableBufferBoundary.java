...
public final class ObservableBufferBoundary<T, U extends Collection<? super T>, Open, Close>
  ...
  protected void subscribeActual(Observer<? super U> t) {
    BufferBoundaryObserver<T, U, Open, Close> parent =
        new BufferBoundaryObserver<>(t, bufferOpen, bufferClose, bufferSupplier);
  ...
  static final class BufferBoundaryObserver<T, C extends Collection<? super T>, Open, Close>
    ...
    void open(Open token) {
      ...
      try {
        ...
        p =
            Objects.requireNonNull(
                bufferClose.apply(token), "The bufferClose returned a null ObservableSource");
      } catch (Throwable ex) {
    ...
    static final class BufferOpenObserver<Open> extends AtomicReference<Disposable>
  ...
  static final class BufferCloseObserver<T, C extends Collection<? super T>>
      extends AtomicReference<Disposable> implements Observer<Object>, Disposable {
