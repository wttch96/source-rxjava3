...
/**
 * Reduce a sequence of values into a single value via an aggregator function and emit the final
 * value or complete if the source is empty.
 *
          ...
          try {
            this.value =
                Objects.requireNonNull(
                    reducer.apply(v, value), "The reducer returned a null value");
          } catch (Throwable ex) {
