...
public final class FlowableScalarXMap {
   ...
   * @param mapper the function that gets the scalar value and should return a Publisher that gets
   *     streamed
   * @return the new Flowable instance
   */
  public static <T, U> Flowable<U> scalarXMap(
      final T value, final Function<? super T, ? extends Publisher<? extends U>> mapper) {
