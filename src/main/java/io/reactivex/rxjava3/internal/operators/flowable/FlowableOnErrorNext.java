...
public final class FlowableOnErrorNext<T> extends AbstractFlowableWithUpstream<T, T> {
  ...
  static final class OnErrorNextSubscriber<T> extends SubscriptionArbiter
      ...
      try {
        p =
            Objects.requireNonNull(
                nextSupplier.apply(t), "The nextSupplier returned a null Publisher");
      } catch (Throwable e) {
