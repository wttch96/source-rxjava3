...
/**
 * Provides an API over MaybeObserver that serializes calls to onXXX and manages cancellation in a
 * safe manner.
 *
      ...
      if (get() != DisposableHelper.DISPOSED) {
        ...
        if (d != DisposableHelper.DISPOSED) {
          try {
            if (value == null) {
              downstream.onError(
                  ExceptionHelper.createNullPointerException(
                      "onSuccess called with a null value."));
            } else {
