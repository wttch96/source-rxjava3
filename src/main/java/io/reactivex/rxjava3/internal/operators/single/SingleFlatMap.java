...
public final class SingleFlatMap<T, R> extends Single<R> {
  ...
  static final class SingleFlatMapCallback<T, R> extends AtomicReference<Disposable>
      ...
      try {
        o =
            Objects.requireNonNull(
                mapper.apply(value), "The single returned by the mapper is null");
      } catch (Throwable e) {
    ...
    static final class FlatMapSingleObserver<R> implements SingleObserver<R> {
      ...
      FlatMapSingleObserver(
          AtomicReference<Disposable> parent, SingleObserver<? super R> downstream) {
        this.parent = parent;
