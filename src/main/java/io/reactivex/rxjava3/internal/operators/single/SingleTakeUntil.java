...
/**
 * Signals the events of the source Single or signals a CancellationException if the other Publisher
 * signalled first.
 *
...
public final class SingleTakeUntil<T, U> extends Single<T> {
  ...
  static final class TakeUntilOtherSubscriber extends AtomicReference<Subscription>
