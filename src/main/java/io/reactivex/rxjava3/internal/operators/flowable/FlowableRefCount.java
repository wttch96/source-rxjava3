...
/**
 * Returns an observable sequence that stays connected to the source as long as there is at least
 * one subscription to the observable sequence.
 *
...
public final class FlowableRefCount<T> extends Flowable<T> {
  ...
  public FlowableRefCount(
      ConnectableFlowable<T> source, int n, long timeout, TimeUnit unit, Scheduler scheduler) {
    this.source = source;
    this.n = n;
  ...
  static final class RefCountSubscriber<T> extends AtomicBoolean
    ...
    RefCountSubscriber(
        Subscriber<? super T> actual, FlowableRefCount<T> parent, RefConnection connection) {
