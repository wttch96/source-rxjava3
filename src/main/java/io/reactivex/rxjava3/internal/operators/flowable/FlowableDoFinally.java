...
public final class FlowableDoFinally<T> extends AbstractFlowableWithUpstream<T, T> {
  ...
  protected void subscribeActual(Subscriber<? super T> s) {
    if (s instanceof ConditionalSubscriber) {
      source.subscribe(
          new DoFinallyConditionalSubscriber<>((ConditionalSubscriber<? super T>) s, onFinally));
    } else {
  ...
  static final class DoFinallyConditionalSubscriber<T> extends BasicIntQueueSubscription<T>
