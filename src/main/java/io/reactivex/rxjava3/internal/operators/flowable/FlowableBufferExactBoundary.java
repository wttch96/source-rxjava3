...
public final class FlowableBufferExactBoundary<T, U extends Collection<? super T>, B>
  ...
  public FlowableBufferExactBoundary(
      Flowable<T> source, Publisher<B> boundary, Supplier<U> bufferSupplier) {
    super(source);
  ...
  protected void subscribeActual(Subscriber<? super U> s) {
    source.subscribe(
        new BufferExactBoundarySubscriber<>(
            new SerializedSubscriber<>(s), bufferSupplier, boundary));
  }
  ...
  static final class BufferExactBoundarySubscriber<T, U extends Collection<? super T>, B>
    ...
    BufferExactBoundarySubscriber(
        Subscriber<? super U> actual, Supplier<U> bufferSupplier, Publisher<B> boundary) {
