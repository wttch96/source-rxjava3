...
/**
 * Maps the success value of the source to a Notification, then maps it back to the corresponding
 * signal type.
 *
...
public final class SingleDematerialize<T, R> extends Maybe<R> {
  ...
  static final class DematerializeObserver<T, R> implements SingleObserver<T>, Disposable {
    ...
    DematerializeObserver(
        MaybeObserver<? super R> downstream, Function<? super T, Notification<R>> selector) {
    ...
    public void onSuccess(T t) {
      ...
      try {
        notification =
            Objects.requireNonNull(selector.apply(t), "The selector returned a null Notification");
      } catch (Throwable ex) {
