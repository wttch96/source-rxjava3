...
public final class ObservableCombineLatest<T, R> extends Observable<R> {
  ...
  public void subscribeActual(Observer<? super R> observer) {
    ...
    if (sources == null) {
      ...
      try {
        for (ObservableSource<? extends T> p : sourcesIterable) {
          ...
          sources[count++] =
              Objects.requireNonNull(p, "The Iterator returned a null ObservableSource");
        }
      } catch (Throwable ex) {
    ...
    LatestCoordinator<T, R> lc =
        new LatestCoordinator<>(observer, combiner, count, bufferSize, delayError);
  ...
  static final class CombinerObserver<T, R> extends AtomicReference<Disposable>
