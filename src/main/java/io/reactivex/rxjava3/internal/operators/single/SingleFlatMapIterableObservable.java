...
public final class SingleFlatMapIterableObservable<T, R> extends Observable<R> {
  ...
  public SingleFlatMapIterableObservable(
  ...
  static final class FlatMapIterableObserver<T, R> extends BasicIntQueueDisposable<R>
    ...
    FlatMapIterableObserver(
        Observer<? super R> actual, Function<? super T, ? extends Iterable<? extends R>> mapper) {
