...
public final class ObservableDematerialize<T, R> extends AbstractObservableWithUpstream<T, R> {
  ...
  public ObservableDematerialize(
  ...
  static final class DematerializeObserver<T, R> implements Observer<T>, Disposable {
    ...
    DematerializeObserver(
        Observer<? super R> downstream, Function<? super T, ? extends Notification<R>> selector) {
      ...
      try {
        notification =
            Objects.requireNonNull(
                selector.apply(item), "The selector returned a null Notification");
      } catch (Throwable ex) {
