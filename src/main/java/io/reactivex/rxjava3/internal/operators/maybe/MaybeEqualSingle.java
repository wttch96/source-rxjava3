...
/**
 * Compares two MaybeSources to see if they are both empty or emit the same value compared via a
 * BiPredicate.
 *
...
public final class MaybeEqualSingle<T> extends Single<Boolean> {
  ...
  public MaybeEqualSingle(
      MaybeSource<? extends T> source1,
  ...
  static final class EqualCoordinator<T> extends AtomicInteger implements Disposable {
    ...
    EqualCoordinator(
        SingleObserver<? super Boolean> actual, BiPredicate<? super T, ? super T> isEqual) {
      super(2);
  ...
  static final class EqualObserver<T> extends AtomicReference<Disposable>
