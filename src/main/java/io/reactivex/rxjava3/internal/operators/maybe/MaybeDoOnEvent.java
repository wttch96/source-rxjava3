...
/**
 * Calls a BiConsumer with the success, error values of the upstream Maybe or with two nulls if the
 * Maybe completed.
 *
...
public final class MaybeDoOnEvent<T> extends AbstractMaybeWithUpstream<T, T> {
  ...
  static final class DoOnEventMaybeObserver<T> implements MaybeObserver<T>, Disposable {
    ...
    DoOnEventMaybeObserver(
        MaybeObserver<? super T> actual, BiConsumer<? super T, ? super Throwable> onEvent) {
