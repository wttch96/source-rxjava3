...
/**
 * Relays the main source's event unless the other Maybe signals an item first or just completes at
 * which point the resulting Maybe is completed.
 *
...
public final class MaybeTakeUntilMaybe<T, U> extends AbstractMaybeWithUpstream<T, T> {
  ...
  static final class TakeUntilMainMaybeObserver<T, U> extends AtomicReference<Disposable>
    ...
    static final class TakeUntilOtherMaybeObserver<U> extends AtomicReference<Disposable>
