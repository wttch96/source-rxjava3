...
public final class MaybeTimeoutMaybe<T, U> extends AbstractMaybeWithUpstream<T, T> {
  ...
  public MaybeTimeoutMaybe(
      MaybeSource<T> source, MaybeSource<U> other, MaybeSource<? extends T> fallback) {
    super(source);
    this.other = other;
  ...
  static final class TimeoutOtherMaybeObserver<T, U> extends AtomicReference<Disposable>
