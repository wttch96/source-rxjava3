...
public final class ObservableCache<T> extends AbstractObservableWithUpstream<T, T>
  ...
  /**
   * A shared instance of an empty array of observers to avoid creating a new empty array when all
   * observers dispose.
   */
  ...
  /**
   * Atomically adds the consumer to the {@link #observers} copy-on-write array if the source has
   * not yet terminated.
   *
