...
public final class FlowableConcatMap<T, R> extends AbstractFlowableWithUpstream<T, R> {
  ...
  abstract static class BaseConcatMapSubscriber<T, R> extends AtomicInteger
    ...
    BaseConcatMapSubscriber(
        Function<? super T, ? extends Publisher<? extends R>> mapper, int prefetch) {
      this.mapper = mapper;
      this.prefetch = prefetch;
  ...
  static final class ConcatMapInner<R> extends SubscriptionArbiter
