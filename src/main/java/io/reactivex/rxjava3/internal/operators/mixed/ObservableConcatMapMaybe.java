...
/**
 * Maps each upstream item into a {@link MaybeSource}, subscribes to them one after the other
 * terminates and relays their success values, optionally delaying any errors till the main and
 * inner sources terminate.
 *
...
public final class ObservableConcatMapMaybe<T, R> extends Observable<R> {
  ...
  public ObservableConcatMapMaybe(
      Observable<T> source,
  ...
  static final class ConcatMapMaybeMainObserver<T, R> extends AtomicInteger
      ...
      for (; ; ) {
        ...
        for (; ; ) {
          ...
          if (s == STATE_INACTIVE) {
            ...
            try {
              ms =
                  Objects.requireNonNull(mapper.apply(v), "The mapper returned a null MaybeSource");
            } catch (Throwable ex) {
    ...
    static final class ConcatMapMaybeObserver<R> extends AtomicReference<Disposable>
