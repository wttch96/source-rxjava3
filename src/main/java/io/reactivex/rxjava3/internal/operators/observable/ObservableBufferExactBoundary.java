...
public final class ObservableBufferExactBoundary<T, U extends Collection<? super T>, B>
  ...
  public ObservableBufferExactBoundary(
      ObservableSource<T> source, ObservableSource<B> boundary, Supplier<U> bufferSupplier) {
    super(source);
  ...
  protected void subscribeActual(Observer<? super U> t) {
    source.subscribe(
        new BufferExactBoundaryObserver<>(new SerializedObserver<>(t), bufferSupplier, boundary));
  }
  ...
  static final class BufferExactBoundaryObserver<T, U extends Collection<? super T>, B>
    ...
    BufferExactBoundaryObserver(
        Observer<? super U> actual, Supplier<U> bufferSupplier, ObservableSource<B> boundary) {
