...
/**
 * After Completable completes, it relays the signals of the ObservableSource to the downstream
 * observer.
 *
...
public final class CompletableAndThenObservable<R> extends Observable<R> {
  ...
  public CompletableAndThenObservable(
      CompletableSource source, ObservableSource<? extends R> other) {
    this.source = source;
    this.other = other;
  }
  ...
  static final class AndThenObservableObserver<R> extends AtomicReference<Disposable>
