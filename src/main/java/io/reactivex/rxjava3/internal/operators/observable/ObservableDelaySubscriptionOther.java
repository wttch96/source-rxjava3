...
/**
 * Delays the subscription to the main source until the other observable fires an event or
 * completes.
 *
...
public final class ObservableDelaySubscriptionOther<T, U> extends Observable<T> {
  ...
  public ObservableDelaySubscriptionOther(
      ObservableSource<? extends T> main, ObservableSource<U> other) {
    this.main = main;
    this.other = other;
  }
