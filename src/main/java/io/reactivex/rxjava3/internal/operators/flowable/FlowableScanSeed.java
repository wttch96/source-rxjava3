...
public final class FlowableScanSeed<T, R> extends AbstractFlowableWithUpstream<T, R> {
  ...
  public FlowableScanSeed(
      Flowable<T> source, Supplier<R> seedSupplier, BiFunction<R, ? super T, R> accumulator) {
    super(source);
  ...
  static final class ScanSeedSubscriber<T, R> extends AtomicInteger
      ...
      try {
        v =
            Objects.requireNonNull(
                accumulator.apply(v, t), "The accumulator returned a null value");
      } catch (Throwable ex) {
