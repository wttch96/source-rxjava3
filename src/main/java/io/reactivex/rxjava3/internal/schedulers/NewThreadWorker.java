...
/**
 * Base class that manages a single-threaded ScheduledExecutorService as a worker but doesn't
 * perform task-tracking operations.
 */
public class NewThreadWorker extends Scheduler.Worker implements Disposable {
  ...
  /**
   * Schedules the given runnable on the underlying executor directly and returns its future wrapped
   * into a Disposable.
   *
  ...
  /**
   * Schedules the given runnable periodically on the underlying executor directly and returns its
   * future wrapped into a Disposable.
   *
  ...
  /**
   * Wraps the given runnable into a ScheduledRunnable and schedules it on the underlying
   * ScheduledExecutorService.
   *
   * <p>If the schedule has been rejected, the ScheduledRunnable.wasScheduled will return false.
   *
   * @param run the runnable instance
   * @param delayTime the time to delay the execution
   * @param unit the time unit
   * @param parent the optional tracker parent to add the created ScheduledRunnable instance to
