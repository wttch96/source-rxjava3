...
public final class IoScheduler extends Scheduler {
  ...
  /**
   * The name of the system property for setting the keep-alive time (in seconds) for this Scheduler
   * workers.
   */
  ...
  static {
    ...
    int priority =
        Math.max(
            Thread.MIN_PRIORITY,
            Math.min(
                Thread.MAX_PRIORITY, Integer.getInteger(KEY_IO_PRIORITY, Thread.NORM_PRIORITY)));
  ...
  static final class CachedWorkerPool implements Runnable {
      ...
      if (unit != null) {
        ...
        task =
            evictor.scheduleWithFixedDelay(
                this, this.keepAliveTime, this.keepAliveTime, TimeUnit.NANOSECONDS);
      }
    ...
    static void evictExpiredWorkers(
        ConcurrentLinkedQueue<ThreadWorker> expiringWorkerQueue, CompositeDisposable allWorkers) {
