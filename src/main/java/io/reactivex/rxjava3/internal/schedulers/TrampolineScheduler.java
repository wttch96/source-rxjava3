...
/**
 * Schedules work on the current thread but does not execute immediately. Work is put in a queue and
 * executed after the current unit of work is completed.
 */
  ...
  static final class TrampolineWorker extends Scheduler.Worker implements Disposable {
    ...
    Disposable enqueue(Runnable action, long execTime) {
      ...
      final TimedRunnable timedRunnable =
          new TimedRunnable(action, execTime, counter.incrementAndGet());
