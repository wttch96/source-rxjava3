...
public enum EmptySubscription implements QueueSubscription<Object> {
  ...
  /**
   * Sets the empty subscription instance on the subscriber and then calls onError with the supplied
   * error.
   *
   * <p>Make sure this is only called if the subscriber hasn't received a subscription already
  ...
  public int requestFusion(int mode) {
    return mode
        & ASYNC; // accept async mode: an onComplete or onError will be signalled after anyway
  }
