 ...
 *
 * <p>Note that the class leaks all methods of {@link java.util.concurrent.atomic.AtomicLong}. Use
 * {@link #complete(Object)} to signal the single value.
 *
 * <p>The this atomic integer stores a bit field:<br>
...
public class DeferredScalarSubscription<T> extends BasicIntQueueSubscription<T> {
  ...
  /**
   * Completes this subscription by indicating the given value should be emitted when the first
   * request arrives.
   *
