...
/**
 * Abstract base class for subscribers that hold another subscriber, a queue and requires
 ...
 */
public abstract class QueueDrainObserver<T, U, V> extends QueueDrainSubscriberPad2
