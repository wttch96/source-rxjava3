...
public abstract class BasicFuseableObserver<T, R> implements Observer<T>, QueueDisposable<R> {
  ...
  /**
   * Calls the upstream's QueueDisposable.requestFusion with the mode and saves the established mode
   * in {@link #sourceMode} if that mode doesn't have the {@link QueueDisposable#BOUNDARY} flag set.
   *
   * <p>If the upstream doesn't support fusion ({@link #qd} is null), the method returns {@link
   * QueueDisposable#NONE}.
   *
