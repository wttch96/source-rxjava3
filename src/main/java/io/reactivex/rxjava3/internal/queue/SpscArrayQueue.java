 ...
 *
 * <p>This implementation is a mashup of the <a
 * href="http://sourceforge.net/projects/mc-fastflow/">Fast Flow</a> algorithm with an optimization
 * of the offer method taken from the <a
 * href="http://staff.ustc.edu.cn/~bhua/publications/IJPP_draft.pdf">BQueue</a> algorithm (a
 * variation on Fast Flow), and adjusted to comply with Queue.offer semantics with regards to
 * capacity.<br>
