...
public abstract class BasicFuseableSubscriber<T, R>
  ...
  /**
   * Calls the upstream's QueueSubscription.requestFusion with the mode and saves the established
   * mode in {@link #sourceMode} if that mode doesn't have the {@link QueueSubscription#BOUNDARY}
   * flag set.
   *
   * <p>If the upstream doesn't support fusion ({@link #qs} is null), the method returns {@link
