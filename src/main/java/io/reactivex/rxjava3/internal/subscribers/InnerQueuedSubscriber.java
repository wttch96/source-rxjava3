...
/**
 * Subscriber that can fuse with the upstream and calls a support interface whenever an event is
 * available.
 *
 * @param <T> the value type
 */
public final class InnerQueuedSubscriber<T> extends AtomicReference<Subscription>
