...
/**
 * Relays signals from upstream according to downstream requests and allows signalling a final value
 * followed by onComplete in a backpressure-aware manner.
 *
 * @param <T> the input value type
 * @param <R> the output value type
 */
public abstract class SinglePostCompleteSubscriber<T, R> extends AtomicLong
  ...
  /**
   * Signals the given value and an onComplete if the downstream is ready to receive the final
   * value.
   *
