 ...
 *
 * <p>Since EmptyDisposable implements QueueDisposable and is empty, don't use it in tests and then
 * signal onNext with it; use Disposables.empty() instead.
 */
public enum EmptyDisposable implements QueueDisposable<Object> {
  /**
   * Since EmptyDisposable implements QueueDisposable and is empty, don't use it in tests and then
   * signal onNext with it; use Disposables.empty() instead.
   */
  INSTANCE,
