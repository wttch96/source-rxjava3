...
/**
 * A Disposable container that allows updating/replacing a Disposable atomically and with respect of
 * disposing the container itself.
 *
 * <p>The class extends AtomicReference directly so watch out for the API leak!
 *
 * @since 2.0
 */
