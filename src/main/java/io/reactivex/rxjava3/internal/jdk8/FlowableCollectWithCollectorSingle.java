 ...
 * @since 3.0.0
 */
public final class FlowableCollectWithCollectorSingle<T, A, R> extends Single<R>
  ...
  public FlowableCollectWithCollectorSingle(
      Flowable<T> source, Collector<? super T, A, R> collector) {
    this.source = source;
