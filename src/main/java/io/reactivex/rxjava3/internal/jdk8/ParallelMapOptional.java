...
public final class ParallelMapOptional<T, R> extends ParallelFlowable<R> {
  ...
  public ParallelMapOptional(
      ParallelFlowable<T> source, Function<? super T, Optional<? extends R>> mapper) {
    this.source = source;
    this.mapper = mapper;
  }
  ...
  public void subscribe(Subscriber<? super R>[] subscribers) {
    ...
    for (int i = 0; i < n; i++) {
      ...
      if (a instanceof ConditionalSubscriber) {
        parents[i] =
            new ParallelMapConditionalSubscriber<>((ConditionalSubscriber<? super R>) a, mapper);
      } else {
  ...
  static final class ParallelMapSubscriber<T, R> implements ConditionalSubscriber<T>, Subscription {
    ...
    ParallelMapSubscriber(
        Subscriber<? super R> actual, Function<? super T, Optional<? extends R>> mapper) {
