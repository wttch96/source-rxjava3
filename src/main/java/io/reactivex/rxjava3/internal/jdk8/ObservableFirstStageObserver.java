...
/**
 * Signals the first element of the source via the underlying CompletableFuture, signals the a
 * default item if the upstream is empty or signals {@link NoSuchElementException}.
 *
