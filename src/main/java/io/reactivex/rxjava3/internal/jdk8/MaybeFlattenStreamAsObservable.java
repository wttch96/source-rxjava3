...
public final class MaybeFlattenStreamAsObservable<T, R> extends Observable<R> {
  ...
  public MaybeFlattenStreamAsObservable(
      Maybe<T> source, Function<? super T, ? extends Stream<? extends R>> mapper) {
    this.source = source;
    this.mapper = mapper;
  }
  ...
  static final class FlattenStreamMultiObserver<T, R> extends BasicIntQueueDisposable<R>
    ...
    FlattenStreamMultiObserver(
        Observer<? super R> downstream, Function<? super T, ? extends Stream<? extends R>> mapper) {
    ...
    public void onSuccess(@NonNull T t) {
      try {
        Stream<? extends R> stream =
            Objects.requireNonNull(mapper.apply(t), "The mapper returned a null Stream");
