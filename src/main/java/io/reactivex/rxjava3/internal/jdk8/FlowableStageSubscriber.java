...
/**
 * Base class that extends CompletableFuture and provides basic infrastructure to notify watchers
 * upon upstream signals.
 *
 * @param <T> the element type
 * @since 3.0.0
 */
abstract class FlowableStageSubscriber<T> extends CompletableFuture<T>
