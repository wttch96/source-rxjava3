...
public final class RxJavaPlugins {
  @Nullable static volatile Consumer<? super Throwable> errorHandler;

  @Nullable static volatile Function<? super Runnable, ? extends Runnable> onScheduleHandler;

  @Nullable
  static volatile Function<? super Supplier<Scheduler>, ? extends Scheduler>
  ...
  @Nullable static volatile Function<? super Scheduler, ? extends Scheduler> onComputationHandler;

  @Nullable static volatile Function<? super Scheduler, ? extends Scheduler> onSingleHandler;

  @Nullable static volatile Function<? super Scheduler, ? extends Scheduler> onIoHandler;

  @Nullable static volatile Function<? super Scheduler, ? extends Scheduler> onNewThreadHandler;
  ...
  @SuppressWarnings("rawtypes")
  @Nullable
  static volatile Function<? super ConnectableFlowable, ? extends ConnectableFlowable>
  ...
  @SuppressWarnings("rawtypes")
  @Nullable
  static volatile Function<? super ConnectableObservable, ? extends ConnectableObservable>
  ...
  @SuppressWarnings("rawtypes")
  @Nullable
  static volatile BiFunction<? super Flowable, ? super Subscriber, ? extends Subscriber>
      onFlowableSubscribe;

  @SuppressWarnings("rawtypes")
  @Nullable
  static volatile BiFunction<? super Maybe, ? super MaybeObserver, ? extends MaybeObserver>
      onMaybeSubscribe;

  @SuppressWarnings("rawtypes")
  @Nullable
  static volatile BiFunction<? super Observable, ? super Observer, ? extends Observer>
      onObservableSubscribe;

  @SuppressWarnings("rawtypes")
  @Nullable
  static volatile BiFunction<? super Single, ? super SingleObserver, ? extends SingleObserver>
      onSingleSubscribe;

  @Nullable
  static volatile BiFunction<
          ? super Completable, ? super CompletableObserver, ? extends CompletableObserver>
      onCompletableSubscribe;

  @Nullable static volatile BooleanSupplier onBeforeBlocking;

  /** Prevents changing the plugins. */
  static volatile boolean lockdown;

  /**
   * If true, attempting to run a blockingX operation on a (by default) computation or single
   * scheduler will throw an IllegalStateException.
   */
   ...
   *
   * <p>This allows container-like environments to prevent clients messing with plugins.
   */
  ...
  /**
   * Enables or disables the blockingX operators to fail with an IllegalStateException on a
   * non-blocking scheduler such as computation or single.
   *
  ...
  /**
   * Returns true if the blockingX operators fail with an IllegalStateException on a non-blocking
   ...
   */
  @Nullable
  public static Function<? super Supplier<Scheduler>, ? extends Scheduler>
   ...
   *
   * <p>Undeliverable errors are those {@code Observer.onError()} invocations that are not allowed
   * to happen on the given consumer type ({@code Observer}, {@code Subscriber}, etc.) due to
   * protocol restrictions because the consumer has either disposed/cancelled its {@code
   * Disposable}/{@code Subscription} or has already terminated with an {@code onError()} or {@code
   * onComplete()} signal.
   *
   * <p>By default, this global error handler prints the stacktrace via {@link
   * Throwable#printStackTrace()} and calls {@link
   * java.lang.Thread.UncaughtExceptionHandler#uncaughtException(Thread, Throwable)} on the current
   * thread.
   *
   * <p>Note that on some platforms, the platform runtime terminates the current application with an
   * error if such uncaught exceptions happen. In this case, it is recommended the application
   * installs a global error handler via the {@link #setErrorHandler(Consumer)} plugin method.
   *
   * @param error the error to report
   * @see #getErrorHandler()
   * @see #setErrorHandler(Consumer)
   * @see <a
   *     href="https://github.com/ReactiveX/RxJava/wiki/What's-different-in-2.0#error-handling">Error
   *     handling Wiki</a>
   */
  ...
  /**
   * Checks if the given error is one of the already named bug cases that should pass through {@link
   * #onError(Throwable)} as is.
   *
   * @param error the error to check
   * @return true if the error should pass through, false if it may be wrapped into an
   ...
   */
  public static void setComputationSchedulerHandler(
   ...
   */
  public static void setInitComputationSchedulerHandler(
   ...
   * @param handler the hook function to set, null allowed, but the function may not return null
   */
  public static void setInitIoSchedulerHandler(
      @Nullable Function<? super Supplier<Scheduler>, ? extends Scheduler> handler) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   * @param handler the hook function to set, null allowed, but the function may not return null
   */
  public static void setInitNewThreadSchedulerHandler(
      @Nullable Function<? super Supplier<Scheduler>, ? extends Scheduler> handler) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   * @param handler the hook function to set, null allowed, but the function may not return null
   */
  public static void setInitSingleSchedulerHandler(
      @Nullable Function<? super Supplier<Scheduler>, ? extends Scheduler> handler) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   * @param handler the hook function to set, null allowed
   */
  public static void setIoSchedulerHandler(
      @Nullable Function<? super Scheduler, ? extends Scheduler> handler) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   * @param handler the hook function to set, null allowed
   */
  public static void setNewThreadSchedulerHandler(
      @Nullable Function<? super Scheduler, ? extends Scheduler> handler) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   * @param handler the hook function to set, null allowed
   */
  public static void setScheduleHandler(
      @Nullable Function<? super Runnable, ? extends Runnable> handler) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   * @param handler the hook function to set, null allowed
   */
  public static void setSingleSchedulerHandler(
      @Nullable Function<? super Scheduler, ? extends Scheduler> handler) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
  ...
  @SuppressWarnings("rawtypes")
  @Nullable
  public static Function<? super ConnectableFlowable, ? extends ConnectableFlowable>
  ...
  @Nullable
  @SuppressWarnings("rawtypes")
  public static BiFunction<? super Flowable, ? super Subscriber, ? extends Subscriber>
  ...
  @Nullable
  @SuppressWarnings("rawtypes")
  public static BiFunction<? super Maybe, ? super MaybeObserver, ? extends MaybeObserver>
      getOnMaybeSubscribe() {
  ...
  @Nullable
  @SuppressWarnings("rawtypes")
  public static BiFunction<? super Single, ? super SingleObserver, ? extends SingleObserver>
  ...
  @Nullable
  @SuppressWarnings("rawtypes")
  public static Function<? super ConnectableObservable, ? extends ConnectableObservable>
  ...
  @Nullable
  @SuppressWarnings("rawtypes")
  public static BiFunction<? super Observable, ? super Observer, ? extends Observer>
   ...
   */
  public static void setOnCompletableAssembly(
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnFlowableAssembly(
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnMaybeAssembly(
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnConnectableFlowableAssembly(
      @Nullable
          Function<? super ConnectableFlowable, ? extends ConnectableFlowable>
              onConnectableFlowableAssembly) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnFlowableSubscribe(
      @Nullable
          BiFunction<? super Flowable, ? super Subscriber, ? extends Subscriber>
              onFlowableSubscribe) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnMaybeSubscribe(
      @Nullable
          BiFunction<? super Maybe, MaybeObserver, ? extends MaybeObserver> onMaybeSubscribe) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnObservableAssembly(
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnConnectableObservableAssembly(
      @Nullable
          Function<? super ConnectableObservable, ? extends ConnectableObservable>
              onConnectableObservableAssembly) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
  ...
  public static void setOnObservableSubscribe(
      @Nullable
          BiFunction<? super Observable, ? super Observer, ? extends Observer>
              onObservableSubscribe) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnSingleAssembly(
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnSingleSubscribe(
      @Nullable
          BiFunction<? super Single, ? super SingleObserver, ? extends SingleObserver>
              onSingleSubscribe) {
    if (lockdown) {
      throw new IllegalStateException("Plugins can't be changed anymore");
    }
  ...
  @NonNull
  public static <T> Subscriber<@NonNull ? super T> onSubscribe(
      @NonNull Flowable<T> source, @NonNull Subscriber<@NonNull ? super T> subscriber) {
  ...
  @SuppressWarnings({"rawtypes", "unchecked"})
  @NonNull
  public static <T> SingleObserver<? super T> onSubscribe(
      @NonNull Single<T> source, @NonNull SingleObserver<? super T> observer) {
    BiFunction<? super Single, ? super SingleObserver, ? extends SingleObserver> f =
        onSingleSubscribe;
    if (f != null) {
      return apply(f, source, observer);
    }
   ...
   */
  @NonNull
  public static CompletableObserver onSubscribe(
      @NonNull Completable source, @NonNull CompletableObserver observer) {
    BiFunction<? super Completable, ? super CompletableObserver, ? extends CompletableObserver> f =
        onCompletableSubscribe;
    if (f != null) {
      return apply(f, source, observer);
    }
  ...
  @SuppressWarnings({"rawtypes", "unchecked"})
  @NonNull
  public static <T> MaybeObserver<? super T> onSubscribe(
      @NonNull Maybe<T> source, @NonNull MaybeObserver<? super T> observer) {
  ...
  public static <T> ConnectableFlowable<T> onAssembly(@NonNull ConnectableFlowable<T> source) {
    Function<? super ConnectableFlowable, ? extends ConnectableFlowable> f =
        onConnectableFlowableAssembly;
    if (f != null) {
      return apply(f, source);
    }
  ...
  public static <T> ConnectableObservable<T> onAssembly(@NonNull ConnectableObservable<T> source) {
    Function<? super ConnectableObservable, ? extends ConnectableObservable> f =
        onConnectableObservableAssembly;
    if (f != null) {
      return apply(f, source);
    }
   ...
   */
  @SuppressWarnings("rawtypes")
  public static void setOnParallelAssembly(
  ...
  @SuppressWarnings("rawtypes")
  @Nullable
  public static Function<? super ParallelFlowable, ? extends ParallelFlowable>
  ...
  /**
   * Called before an operator attempts a blocking operation such as awaiting a condition or signal
   * and should return true to indicate the operator should not block but throw an
  ...
  /**
   * Set the handler that is called when an operator attempts a blocking await; the handler should
   * return true to prevent the blocking and to signal an IllegalStateException instead.
   *
   * <p>History: 2.0.5 - experimental
   *
   * @param handler the handler to set, null resets to the default handler that always returns false
   ...
   * <p>History: 2.0.5 - experimental
   *
   * @param threadFactory thread factory to use for creating worker threads. Note that this takes
   *     precedence over any system properties for configuring new thread creation. Cannot be null.
  ...
  /**
   * Create an instance of the default {@link Scheduler} used for {@link Schedulers#io()} except
  ...
  /**
   * Create an instance of the default {@link Scheduler} used for {@link Schedulers#single()} except
   * using {@code threadFactory} for thread creation.
   *
   * <p>History: 2.0.5 - experimental
   *
  ...
  /**
   * Wraps the call to the function in try-catch and propagates thrown checked exceptions as
   * RuntimeException.
   *
  ...
  /**
   * Wraps the call to the Scheduler creation supplier in try-catch and propagates thrown checked
   * exceptions as RuntimeException and enforces that result is not null.
   *
   * @param s the {@link Supplier} which returns a {@link Scheduler}, not null (not verified).
   *     Cannot return null
  ...
  /**
   * Wraps the call to the Scheduler creation function in try-catch and propagates thrown checked
   * exceptions as RuntimeException and enforces that result is not null.
   *
   ...
   */
  @NonNull
  static Scheduler applyRequireNonNull(
