...
/**
 * An {@link Observer}, {@link MaybeObserver}, {@link SingleObserver} and {@link
 * CompletableObserver} composite that can record events from {@link Observable}s, {@link Maybe}s,
 * {@link Single}s and {@link Completable}s and allows making assertions about them.
 *
 * <p>You can override the {@link #onSubscribe(Disposable)}, {@link #onNext(Object)}, {@link
 * #onError(Throwable)}, {@link #onComplete()} and {@link #onSuccess(Object)} methods but not the
 * others (this is by design).
 *
 * <p>The {@code TestObserver} implements {@link Disposable} for convenience where dispose calls
 * cancel.
 *
 * @param <T> the value type
 * @see io.reactivex.rxjava3.subscribers.TestSubscriber
 */
public class TestObserver<T> extends BaseTestConsumer<T, TestObserver<T>>
