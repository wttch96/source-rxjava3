 ...
 *
 * <p>Note that {@link #onSubscribe(Disposable)} is not serialized in respect of the other methods
 * so make sure the {@code onSubscribe()} is called with a non-null {@link Disposable} before any of
...
public final class SerializedObserver<T> implements Observer<T>, Disposable {
  ...
  /**
   * Construct a SerializedObserver by wrapping the given actual {@link Observer} and optionally
   * delaying the errors till all regular values have been emitted from the internal buffer.
   *
